...
def get_testresults():
    ...
    pagination = db.session.query(Testresult.id, Testresult.case_id, Testcase.case_name, Testresult.test_result,
                                  ...
                                  Testcase.interface_id, Interface.system_id, Interface.project_id).filter(condition).join(Testcase, Testresult.case_id == Testcase.id).join(Interface,
    ...
    return jsonify({
        'code': 1,
        'testresults': [{'id': testresult.id, 'case_id': testresult.case_id, 'case_name': testresult.case_name, 'test_result': testresult.test_result,
